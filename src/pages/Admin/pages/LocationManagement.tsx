                                            ...
                                            <div className="group">
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        value={formData.giaVe === 0 && formData.giaVe.toString() === '0' ? 0 : formData.giaVe}
                                            ...
                                            <div className="group">
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        value={formData.thoiGianThamQuanDuKien === 0 && formData.thoiGianThamQuanDuKien.toString() === '0' ? 0 : formData.thoiGianThamQuanDuKien}
                                                        onKeyDown={(e) => ["-", "e", "E", "+"].includes(e.key) && e.preventDefault()}
                                                        onChange={e => {
                                                            const val = e.target.value;
